...
/*   Updated: 2023/03/09 23:54:56 by cdescour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pos save_pos(char **info1)
{
	...
	pos->z = ft_atoi(temp3[0] * 1000) + ft_atoi_size(temp3[1], 3);
	free_tab (temp1);
	free_tab (temp2);
	free_tab (temp3);
}

t_dir dir(char **info2)
{
	t_dir	*pos;
	char	**temp1;
	char	**temp2;
	...
	dir = malloc(sizeof(t_pos));
	dir->x = ft_atoi(temp1[0]) * 1000 + ft_atoi_size(temp1[1], 3);
	dir->y = ft_atoi(temp2[0] * 1000) + ft_atoi_size(temp2[1], 3);
	dir->z = ft_atoi(temp3[0] * 1000) + ft_atoi_size(temp3[1], 3);
	free_tab (temp1);
	free_tab (temp2);
	free_tab (temp3);
}